...
from .models import Film, Vote

class FilmRecommendationProvider(RecommendationProvider):
    def get_users(self):
...
recommendation_registry.register(Vote, [Film], FilmRecommendationProvider)